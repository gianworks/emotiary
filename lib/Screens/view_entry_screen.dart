    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Center(child: Text("Feeling ${_entry["mood"]}", style: TextStyle(fontSize: 18))),
          SizedBox(height: 15),
          Text("${_entry["title"]}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
          SizedBox(height: 10),
          Text("${_entry["body"]}", style: TextStyle(fontSize: 16)),
        ],
      )
    );
  }
