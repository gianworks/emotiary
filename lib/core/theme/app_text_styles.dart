...
class AppTextStyles {
  ...
  static const TextStyle titleSmall = TextStyle(fontFamily: "Urbanist", fontSize: 16, color: AppColors.darkBrown, fontWeight: FontWeight.w600);
  static const TextStyle titleMedium = TextStyle(fontFamily: "Urbanist", fontSize: 20, color: AppColors.darkBrown, fontWeight: FontWeight.w600);
  static const TextStyle titleLarge = TextStyle(fontFamily: "Urbanist", fontSize: 24, color: AppColors.darkBrown, fontWeight: FontWeight.w600);
